...
import com.sycode.sy_ky_video.app.utils.TimeUtils


/**
 * Created by moment on 2018/2/5.
 */
class VideoCollectionAdapter(context: Context, private val mDatas: List<VideoCollection>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val view = mInflater.inflate(
            R.layout.video_collection_recycler_item,
            viewGroup, false
        )
