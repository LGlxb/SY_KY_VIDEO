...
import com.sycode.sy_ky_video.mvp.ui.activity.CategoriesTagListActivity
...
@ActivityScope
@Component(
    modules = arrayOf(CategoriesTagListModule::class),
    dependencies = arrayOf(AppComponent::class)
)
interface CategoriesTagListComponent {
    fun inject(activity: CategoriesTagListActivity)
}