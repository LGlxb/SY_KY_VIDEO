...
import com.sycode.sy_ky_video.mvp.ui.activity.welcome.SplashActivity
import com.sycode.sy_ky_video.app.utils.HttpUtils
import com.sycode.sy_ky_video.app.weight.loadCallBack.EmptyCallback
import com.sycode.sy_ky_video.app.weight.loadCallBack.ErrorCallback
import com.sycode.sy_ky_video.app.weight.loadCallBack.LoadingCallback
import com.sycode.sy_ky_video.mvp.ui.activity.error.ErrorActivity
...
//        }
    ...
    fun initKeepLive(application: Application) {
        ...
        val notification = ForegroundNotification("WanAndroid服务", "WanAndroid服务正在运行中" +
                ...
                ForegroundNotificationClickListener { _, _ -> //可以做一些唤醒程序的操作，这里只是简单地启动了应用
