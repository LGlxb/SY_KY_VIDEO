package com.sycode.sy_ky_video.mvp.contract
...
interface DailyContract {
    interface View : IView {
        //获取分类
        fun onShowCategory(resultList: List<CategoryBean>)
        fun onShowFail(throwable: Throwable?)
    }

    interface Model : IModel {
        //获取分类
        fun onShowCategory(): Observable<List<CategoryBean>>
    }
}
