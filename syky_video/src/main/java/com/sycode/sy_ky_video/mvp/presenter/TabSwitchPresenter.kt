 ...
 */
@ActivityScope
class TabSwitchPresenter
@Inject
constructor(model: TabSwitchContract.Model, rootView: TabSwitchContract.View) :
    BasePresenter<TabSwitchContract.Model, TabSwitchContract.View>(model, rootView) {
    @Inject
