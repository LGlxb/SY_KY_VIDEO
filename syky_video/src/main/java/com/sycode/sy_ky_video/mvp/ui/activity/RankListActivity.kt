...
import com.sycode.sy_ky_video.di.component.DaggerRankListComponent
import com.sycode.sy_ky_video.di.module.RankListModule
import com.sycode.sy_ky_video.mvp.contract.RankListContract
import com.sycode.sy_ky_video.mvp.presenter.RankListPresenter
...
class RankListActivity : BaseActivity<RankListPresenter>(), RankListContract.View {
    ...
    override fun initView(savedInstanceState: Bundle?): Int {
        return R.layout.activity_rank_list //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
