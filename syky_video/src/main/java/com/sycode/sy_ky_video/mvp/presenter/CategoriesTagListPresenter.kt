 ...
 */
@ActivityScope
class CategoriesTagListPresenter
@Inject
constructor(model: CategoriesTagListContract.Model, rootView: CategoriesTagListContract.View) :
    BasePresenter<CategoriesTagListContract.Model, CategoriesTagListContract.View>(
        model,
        rootView
    ) {
    @Inject
